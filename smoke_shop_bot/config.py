...
PAYMENT_SHAMCASH_NUMBER = os.getenv("PAYMENT_SHAMCASH_NUMBER", "[رقم حساب شام كاش]")
PAYMENT_SHAMCASH_NAME = os.getenv("PAYMENT_SHAMCASH_NAME", "[اسم صاحب حساب شام كاش]")
PAYMENT_SYRIATELCASH_NUMBER = os.getenv("PAYMENT_SYRIATELCASH_NUMBER", "[رقم حساب سيريتل كاش]")
PAYMENT_SYRIATELCASH_NAME = os.getenv("PAYMENT_SYRIATELCASH_NAME", "[اسم صاحب حساب سيريتل كاش]")
