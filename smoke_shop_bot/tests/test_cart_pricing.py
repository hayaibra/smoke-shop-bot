...
class TestRealCatalogAndPriceSheetConsistency(unittest.TestCase):
    ...
    ORPHANED_PRICE_SHEET_ITEMS = {
        ...
        # صنف "فحم إيكو نارا" (بالهمزة، بلا وصف لون) محذوف من ماركة "ايكو
        # نارا" — الصنف التاني بالماركة انعدّل اسمه بدل ما يتحذف (شوف
        # test_catalog_logic.py).
        ("ايكو نارا", "فحم إيكو نارا"),
    }
...
class TestRealCatalogCharcoalCartonUnits(unittest.TestCase):
    ...
    EXPECTED_CARTON_MULTIPLIER = {
        ...
        # كرتونة "ايكو نارا" الحقيقية ١٦ علبة (استثناء عن القياسي ٥٠).
        ...
        # التاجرة عدّلت كرتونة "ولف ربع كيلو" لـ٤٠ (كانت ٥٠ القياسي).
